...
#define SYNC "0000101011010101010101010101010101010101010101010101010101010101010101010"
// ?: changing had no effect
// X: changing caused it to stop
//                    "?X X                     X                              X"
...
const char* QuietCool::speed_settings[] = {
    PREAMBLE "0110011001100110", // PRE
    PREAMBLE "1011000110110001", // H1
    PREAMBLE "1011001010110010", // H2
    PREAMBLE "1011010010110100", // H4
    PREAMBLE "1011100010111000", // H8
    PREAMBLE "1011110010111100", // H12
    PREAMBLE "1011111110111111", // HON
    PREAMBLE "1011000010110000", // HOFF
    PREAMBLE "1010000110100001", // M1
    PREAMBLE "1010001010100010", // M2
    PREAMBLE "1010010010100100", // M4
    PREAMBLE "1010100010101000", // M8
    PREAMBLE "1010110010101100", // M12
    PREAMBLE "1010111110101111", // MON
    PREAMBLE "1010000010100000", // MOFF
    PREAMBLE "1001000110010001", // L1
    PREAMBLE "1001001010010010", // L2
    PREAMBLE "1001010010010100", // L4
    PREAMBLE "1001100010011000", // L8
    PREAMBLE "1001110010011100", // L12
    PREAMBLE "1001111110011111", // LON
    PREAMBLE "1001000010010000", // LOFF
};
